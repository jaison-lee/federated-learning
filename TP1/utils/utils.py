...
from torchvision.transforms import Compose, ToTensor, Normalize, Pad, RandomCrop
...
def get_learner(experiment_name, device, optimizer_name, lr, seed):
    ...
    if experiment_name == "mnist" or experiment_name == "cifar10":
    ...
    if experiment_name == "mnist":
        ...
        transform = Compose(
            [
                ...
                # Normalize((0.4914, 0.4822, 0.4465), (0.247, 0.2434, 0.2616)),
            ]
        )
...
def get_aggregator(
    aggregator_type, clients, clients_weights, global_learner, logger, verbose, seed
):
    """
    Parameters
    ----------
