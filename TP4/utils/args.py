...
def parse_args(args_list=None):
    ...
    parser.add_argument(
        "--experiment",
        help="name of the experiment, possible are:" '{"mnist"}',
        type=str,
        required=True,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--aggregator_type",
        help="aggregator type; possible are:" '{"centralized", "median"}',
        type=str,
        default="centralized",
    )
    parser.add_argument(
    ...
    parser.add_argument("--logs_dir", help="directory to write logs;", required=True)
    parser.add_argument(
        "--seed",
    ...
    parser.add_argument(
        "--prop",
        help="proportion of malicious client in the system",
        type=float,
        default=0.0,
    )
