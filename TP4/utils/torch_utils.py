...
def median_model(learners, target_learner):
    r"""computes the median of learners and store it into target_learner
    ...
    param_tensors = torch.stack(param_tensors)
    median_params_tensor, _ = torch.median(param_tensors, dim=0)
