...
def get_learner(
    experiment_name, device, optimizer_name, lr, mu, seed, mal_client=False
):
    """
    ...
    optimizer = get_optimizer(optimizer_name=optimizer_name, model=model, lr=lr, mu=mu)
...
def init_client(args, client_id, client_dir, logger, mal_client=False):
